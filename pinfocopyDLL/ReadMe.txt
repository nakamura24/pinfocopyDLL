========================================================================
 ダイナミック リンク ライブラリ: pinfocopyDLL プロジェクトの概要
========================================================================

この pinfocopyDLL DLL は、AppWizard により作成されました。

このファイルには、pinfocopyDLL 
アプリケーションを構成する各ファイルの内容の概要が含まれています。


pinfocopyDLL.vcxproj
